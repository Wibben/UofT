...
private:
   ...
   bool traverseAndInsert(TreeNode* current, DBentry* newEntry);
   
   // Traverse the tree to find the correct node
   TreeNode* traverseAndFind(TreeNode* current, string name, int probes);
   
   // Traverse the tree to find the parent node of an entry
   TreeNode* traverseAndFindParent(TreeNode* current, string name);
   ...
   void traverseAndDelete(TreeNode* current);
   
   // Traverse the tree to count active entries
   int traverseAndCountActive(TreeNode* current) const;
