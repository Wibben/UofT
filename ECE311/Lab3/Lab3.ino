...
//PARAMETERS
const double K = 43.7;     // insert your K value here
const double Ti = 0.0863;    // insert your Ti value here
const double a = 0.788;     // insert your a value here
const double b = 5.5;     // insert your b value here
