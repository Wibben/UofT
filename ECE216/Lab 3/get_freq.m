...
%above
semitone_mult = power(octave_mult,1/num_octave_keys); %frequency ratio of a semitone (two neighbouring keys)
semitone_jump = num - middle_A_num;  %how many semitones away from middle A our key is
f = middle_A_freq * power(semitone_mult,semitone_jump); %our key's frequency
